...
public class Bottles99Test {
        ...
        @Test
        public void testURL() {
            this.driver.get("http://www.99-bottles-of-beer.net/");
            String actualResult = this.driver.getCurrentUrl();
        ...
        public void testTitle() {
            this.driver.get("http://www.99-bottles-of-beer.net/");
            String actualResult = this.driver.findElement(By.xpath("//div[@id = 'main']/h2")).getText();
            Assert.assertEquals(actualResult, "Welcome to 99 Bottles of Beer");
        }

        @Test
        public void testSongLyric() {
            this.driver.get("http://www.99-bottles-of-beer.net/lyrics.html");
            ...
            for(int i = 0; i < itemList.size(); ++i) {
                if (i == 99) {
                    actualResult = actualResult + ((WebElement)itemList.get(i)).getText();
                } else {
                    actualResult = actualResult + ((WebElement)itemList.get(i)).getText() + "\n";
                }
            }
