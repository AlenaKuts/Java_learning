...
public class BottlesTest {
    ...
    public void testSongLyric() {
        driver.get("http://www.99-bottles-of-beer.net/lyrics.html");

        List<WebElement> itemList = driver.findElements(By.xpath("//div[@id = 'main']/p"));
        ...
        for (int i = 0; i < itemList.size(); i++) {
            if (i == 99){
                actualResult += itemList.get(i).getText();
            } else {
                actualResult += (itemList.get(i).getText() + "\n");
            }
        }
